...
\begin{equation}
    ...
    % Adjust tensor sizes with the package key to keep labels consistent.
    \begin{tikzpicture}[tensornetwork, scale=2, /tensor network/tensorsize=20pt]
        \node[atensor, label=\(A_1\)]     (A1) at (1, 0) {};
        \node[atensor, label=\(A_2\)]     (A2) at (2, 0) {};
        \node[atensor, label=\(A_3\)]     (A3) at (3, 0) {};
        \node[notensor]                   (A4) at (4, 0) {\(\ldots\)};
...
\begin{math}
    \ket{\Psi} =
    \begin{tikzpicture}[tensornetwork, scale=0.75, /tensor network/tensorsize=7.5pt]
        \node[atensor]  (A1) at (1, 0) {};
        \node[atensor]  (A2) at (2, 0) {};
        \node[atensor]  (A3) at (3, 0) {};
        \node[notensor] (A4) at (4, 0) {\(\ldots\)};
